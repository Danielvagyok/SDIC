...
HD_PWD='C:/Users/matya/OneDrive/Documents/Vivado/sdic_project/sdic_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scoreboard_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scoreboard_counter.tcl -notrace
