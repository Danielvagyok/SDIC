...
HD_PWD='C:/Users/matya/OneDrive/Documents/Vivado/sdic_project/sdic_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scoreboard_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scoreboard_counter.tcl
